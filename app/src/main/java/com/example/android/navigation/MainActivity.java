...
//    private static final String COORDINATES = "34.3852964,-119.4875023";
    private static final String COORDINATES = "-22.927824, -45.459572";
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()){
                    case R.id.action_hours:
                        Toast.makeText(MainActivity.this, "Display hours", Toast.LENGTH_SHORT).show();
                        break;

                    case R.id.action_dress_code:
                        Toast.makeText(MainActivity.this, "Display dress code", Toast.LENGTH_SHORT).show();
                        break;
